...
public class IPv6AddressParseOperatorConversion extends DirectOperatorConversion
{
...
//      .returnTypeInference(ReturnTypes.BIGINT_NULLABLE) // todo.
      .returnTypeNullable(SqlTypeName.CHAR)
      .functionCategory(SqlFunctionCategory.USER_DEFINED_FUNCTION)
      .build();

  public IPv6AddressParseOperatorConversion()
  {
    super(SQL_FUNCTION, IPv6AddressParseExprMacro.FN_NAME);
  }
